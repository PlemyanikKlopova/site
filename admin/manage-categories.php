...
<?php if(isset($_SESSION['add-category-success'])) :  //shows if add category was succcessful?>
...
<?php elseif(isset($_SESSION['add-category'])) :  //shows if add category was not succcessful?>
...
<?php elseif(isset($_SESSION['edit-category'])) :  //shows if edit category was not succcessful?>
        <div class="alert_message error container" >
                <p>
...
<?php elseif(isset($_SESSION['edit-category-success'])) :  //shows if edit category was  succcessful?>
        <div class="alert_message success container" >
                <p>
...
<?php elseif(isset($_SESSION['delete-category-success'])) :  //shows if delete category was  succcessful?>
        <div class="alert_message success container" >
                <p>
